...
<body>
    <?php require '../assets/partials/cust-header.php';
            ...
            <section id="dashboard">
                ...
                <div id="status">
                    <div id="Booking" class="info-box status-item">
                        ...
                        <a href="cust_booking.php">View More <i class="fas fa-arrow-right"></i></a>
                    </div>
                    <div id="Bus" class="info-box status-item">
                        ...
                        <a href="cust_bus.php">View More <i class="fas fa-arrow-right"></i></a>
                    </div>
                    <div id="Route" class="info-box status-item">
                        ...
                        <a href="cust_route.php">View More <i class="fas fa-arrow-right"></i></a>
                    </div>
                    <div id="Seat" class="info-box status-item">
                        ...
                        <a href="cust_seat.php">View More <i class="fas fa-arrow-right"></i></a>
                    </div>
                </div>
                ...
                <div id="user">
                    <div id="Customer" class="info-box user-item">
                        ...
                        <a href="reserve.php">View More <i class="fas fa-arrow-right"></i></a>
                    <!--</div>
                ...
                <footer>
                    <p>
                        <i class="far fa-copyright"></i> <?php echo date('Y');?> - BusPro Bus Ticket Booking System | Made by ADA
                        </p>
                </footer>
        </div>
    </main>
