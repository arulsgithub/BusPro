...
<body>
    ...
    <section id="home">
        <div id="route-search-form">
            <h1>BusPro Bus Ticket Booking System</h1>

            <p class="text-center">Welcome to BusPro Bus Ticket Booking System. Login now to manage bus tickets and much more. OR, simply scroll down to check the Ticket status using Passenger Name Record (PNR number)</p>
